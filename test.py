...
# from emotions import Emotion_Calculation as Emotion_Calculation
class Train:
    """
    ...
    def __init__(self, app_client_id, app_client_secret, verbose=True, **kwargs):
        ...
        # self.emotion_calc =  Emotion_Calculation(person="test_subject")
    ...
    def on_new_pow_data(self, *args, **kwargs):
        ...
        emotion_metrics = self.emotion_calc.update(data["pow"])
        # print(f"Emotion Metrics: {emotion_metrics}")
        if self.verbose:
